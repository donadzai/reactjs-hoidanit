...
function Header() {
    ...
    let number = 0;
    const getTitle = () => {
        const titles = ['Tìm kiếm bác sĩ', 'Tìm kiếm bệnh viện', 'Tìm kiếm gói khám phù hợp'];
        const titleSearch = titles[number];
                ...
                <div className={cx('content')}>
                    <div className={cx('left-content')}>
                        ...
                        <a href="/home" className={cx('logo')}>
                            <svg viewBox="0 0 666.63 146.21" preserveAspectRatio="none" width="100%" height="100%">
                                <path
                    ...
                    <div className={cx('center-content')}>
                        <div className={className}>Tất cả</div>
                        <div className={cx('child-content')}>Tại nhà</div>
                        <div className={cx('child-content')}>Tại viện</div>
                        <div className={cx('child-content')}>Sống khỏe</div>
